...
tempLeadSeedRouter.post("/seed-test-leads", async (req: Request, res: Response) => {
    try {
        ...
        const sampleLeads = [
            ...
            },
            {
                ...
                customFields: { companySize: "10-20", budget: "₹20,000", platform: "Web" },
                stage: "Intake",
                status: "Active",
                source: {
                    name: "Webform",
                ...
                notes: [{ message: "Requested a callback", createdAt: new Date("2025-11-13T12:00:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "51-200", budget: "₹50,000", platform: "Web" },
                stage: "Qualified",
                status: "Active",
                source: {
                    name: "Chatbot",
                ...
                notes: [
                    { message: "Asked about support response times", createdAt: new Date("2025-11-14T09:20:00.000Z") }
                ],
            ...
            },
            {
                ...
                customFields: { companySize: "5-10", budget: "₹10,000", platform: "Mobile" },
                stage: "Converted",
                status: "Active",
                source: {
                    name: "Referral",
                ...
                notes: [{ message: "Converted through referral", createdAt: new Date("2025-11-15T15:00:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "20-50", budget: "₹30,000", platform: "Mobile" },
                stage: "Qualified",
                status: "Pending",
                source: {
                    name: "Webform",
                ...
                notes: [{ message: "Needs followup next week", createdAt: new Date("2025-11-16T11:00:00.000Z") }],
            ...
            },
            {
                ...
                phone: "+917755446633",
                message: "Undecided",
                customFields: { companySize: "201-500", budget: "₹80,000", platform: "Web" },
                stage: "Intake",
                status: "Inactive",
                source: {
                    name: "Chatbot",
                ...
                notes: [{ message: "No reply after initial chat", createdAt: new Date("2025-11-17T13:25:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "10-20", budget: "₹15,000", platform: "Web" },
                stage: "Qualified",
                status: "Active",
                source: {
                    name: "Webform",
                ...
                notes: [{ message: "Documents sent", createdAt: new Date("2025-11-18T08:00:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "51-200", budget: "₹60,000", platform: "Web" },
                stage: "Intake",
                status: "Active",
                source: {
                    name: "Chatbot",
                ...
                notes: [{ message: "Looking for technical details", createdAt: new Date("2025-11-19T10:05:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "20-50", budget: "₹25,000", platform: "Web" },
                stage: "Qualified",
                status: "Active",
                source: {
                    name: "Referral",
                ...
                notes: [{ message: "Sent case studies", createdAt: new Date("2025-11-20T14:30:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "1-5", budget: "₹5,000", platform: "Web" },
                stage: "Intake",
                status: "Pending",
                source: {
                    name: "Webform",
                ...
                notes: [{ message: "Sent trial signup link", createdAt: new Date("2025-11-21T16:45:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "51-200", budget: "₹70,000", platform: "Web" },
                stage: "Converted",
                status: "Active",
                source: {
                    name: "Referral",
                ...
                notes: [{ message: "Shared CRM integration doc", createdAt: new Date("2025-11-22T18:10:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "201-500", budget: "₹90,000", platform: "Mobile" },
                stage: "Qualified",
                status: "Active",
                source: {
                    name: "Chatbot",
                ...
                notes: [{ message: "Sent price sheet", createdAt: new Date("2025-11-23T19:20:00.000Z") }],
            ...
            },
            {
                ...
                customFields: { companySize: "5-10", budget: "₹8000", platform: "Web" },
                stage: "Intake",
                status: "Pending",
                source: {
                    name: "Webform",
                ...
                notes: [{ message: "Asked for more info", createdAt: new Date("2025-11-24T20:00:00.000Z") }],
                meta: { ip: "103.211.45.133", userAgent: "Mozilla/5.0" },
            }
        ];
        // Insert all leads
        await LeadModel.insertMany(sampleLeads);
        res.status(201).json({ message: "Test leads inserted successfully", count: sampleLeads.length });
    } catch (error) {
